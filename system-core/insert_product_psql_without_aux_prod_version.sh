...
# 2021-09-20 : sol : versioning suppressed when inserting in auxiliary_product.
#		     Needed when inserting new ADFs in a processing baseline with script 
#		     6_give_ADF_version_in_DB_and_extract_ADF_without_version.sh
#
# -------------------------------------------------------------------
